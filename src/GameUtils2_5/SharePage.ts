...
class SharePage extends egret.DisplayObjectContainer
{
    ...
    private desctext: string = '盛讯小游戏--疯狂龙舟';
    ...
    private getWeiXinShareTimeline() {
        ...
        bodyMenuShareTimeline.link = 'http://czlongzrun.h5.gamexun.com/';
        bodyMenuShareTimeline.imgUrl = 'http://czlongzrun.h5.gamexun.com/shareicon.png';
    ...
    private getWeiXinShareAppMessage(){
        ...
        bodyMenuShareAppMessage.title = '盛讯小游戏--疯狂龙舟';
        bodyMenuShareAppMessage.desc = this.desctext;
        bodyMenuShareAppMessage.link = 'http://czlongzrun.h5.gamexun.com/';
        bodyMenuShareAppMessage.imgUrl = 'http://czlongzrun.h5.gamexun.com/shareicon.png';
